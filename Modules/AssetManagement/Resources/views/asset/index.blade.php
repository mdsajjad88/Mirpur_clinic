...
@section('content')
	...
	<div class="modal fade" id="asset_show_modal" tabindex="-1" role="dialog"></div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		// 		success: function (response) {
		// 			if (response.view) {
		// 				$("#asset_show_modal").html(response.view); // Inject valid HTML
		// 				$("#asset_show_modal").modal('show');
		// 			} else {
		// 				console.error("Invalid response format");
		// 			}
		// 		},
		// 		error: function (xhr, status, error) {
		// 			console.error("Error loading asset modal:", error);
		// 		}
		// 	});
		// });

		$(document).on('click', '.show_asset', function (e) {
			e.preventDefault();
			var href = $(this).data('href');
			console.log('Loading content from:', href); // Debugging line
			$('#asset_show_modal').load(href, function () {
				console.log('Content loaded, showing modal'); // Debugging line
				$(this).modal('show');
			});
		});
