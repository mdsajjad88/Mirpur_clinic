<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      @include('clinic::cash_register.payment_details')
      <hr>
    ...
    <div class="modal-footer">
      ...
      <a hidden href="{{ action('App\Http\Controllers\CashRegisterController@posPrint', [$id]) }}" class="btn btn-primary no-print">
        Print(POS)
      </a>  
      <a href="{{ action('App\Http\Controllers\CashRegisterController@clinicA4Print', [$id]) }}" class="btn btn-primary no-print">
        Print(A4)
      </a>  
