...
@endphp
@section('title')
    {{ request()->get('type') }} @lang('clinic::lang.categories')
@endsection
    ...
    @component('components.widget', ['class' => 'box-solid', 'can_add' => $can_add])
            ...
            @slot('tool')
                <div class="box-tools">
                    ...
                    data-href="{{action([\Modules\Clinic\Http\Controllers\ClinicCategoryController::class, 'create'])}}?type={{request()->get('type')}}" 
