    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">
                    @lang('clinic::doctor.add_reference')
            </h4>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <br>
                        <label>
                            {!! Form::checkbox('is_doctor', 1, false, [
                                'class' => 'is_doctor',
                                'id' => 'is_doctor',
                ...
                <div class="doctor_designation hide">
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('designation', __('clinic::lang.doctor_designation') . ':') !!}
                            <div class="input-group">

                                {!! Form::text('designation', null, ['class' => 'form-control', 'placeholder' => __('clinic::lang.doctor_designation')]) !!}
                            </div>
                        </div>
                    </div>
                </div>
