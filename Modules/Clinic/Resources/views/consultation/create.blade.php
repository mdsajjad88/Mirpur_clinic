...
@section('title', __('clinic::lang.create_consultation'))
@section('content')
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('clinic::lang.create_consultation')])
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('name', !empty($duplicate_product->name) ? $duplicate_product->name : null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('clinic::lang.consultation_name'),
                        ]) !!}
                    </div>
                </div>
                ...
                <div hidden class="col-sm-3 @if (!session('business.enable_brand')) hide @endif">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('clinic.brand.create')) disabled @endif
                                    ...
                                    data-href="{{ action([\Modules\Clinic\Http\Controllers\ClinicBrandController::class, 'create']) . '?sub_type=consultation&quick_add=true' }}"
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('type', __('clinic::lang.consultation_type') . ':*') !!} @show_tooltip(__('tooltip.product_type'))
                        {!! Form::hidden('product_type', 'consultation') !!}
