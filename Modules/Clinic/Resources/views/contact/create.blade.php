    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-3 sms-hide">
                <div class="form-group">
                    {!! Form::checkbox('send_sms', 1, false, ['class' => 'form-check-input', 'id' => 'send_sms', 'style' => 'width: 1.2em; height: 1.2em;']) !!}
                    {!! Form::label('send_sms', __('Send SMS') . ' ', ['class' => 'form-check-label']) !!}
                </div>
            </div>
            <div class="clearfix"></div>
        ...
        @include('clinic::contact.module_form_part')
    </div>
