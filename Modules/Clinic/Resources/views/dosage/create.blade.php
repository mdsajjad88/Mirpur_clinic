<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        @php
            $form_id = 'dosage_add_form';           
            $url = action([\Modules\Clinic\Http\Controllers\DosageController::class, 'store']); 
        @endphp
...
<script>
    $(document).ready(function() {
        ...
        $('form#dosage_add_form').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success == true) {
                        ...
                        $('#clinic_dosage_table').DataTable().ajax.reload();
