            ...
            <div class="patient-info col-md-9">
                ...
                <div class="row @if (!empty($guidline_id)) show @else hide @endif" id="guidlines_info">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('guidline_description', $guidline_id ? $nu->guidline_description : '', ['class' => 'form-control', 'id' => 'guidline_description']) !!}
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                {!! Form::select('old_prescription', $otherPrescriptions, $nupresId??null, ['class' => 'form-control select2', 'id' => 'old_prescription', 'placeholder' => 'Select Prescription']) !!}
