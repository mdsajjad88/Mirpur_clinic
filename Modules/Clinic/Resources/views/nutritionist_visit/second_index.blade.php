...
@section('content')
    <section class="content no-print">
        ...
        @component('components.filters', ['title' => __('report.filters'), 'class' => 'box-primary'])
            <div class="row">
                <div class="col-md-3">
                    ...
                    {!! Form::date('appointment_date', now()->format('Y-m-d'), [
                        'class' => 'form-control',
                        'id' => 'appointment_date',
                        'min' => '',
                        'max' => '',
        ...
        @endcomponent
        <div class="modal fade show_prescription" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        </div>
    </section>
