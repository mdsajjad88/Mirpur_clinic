...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-2 text-right">
            <button data-href="{{action([\Modules\Clinic\Http\Controllers\PatientController::class, 'getLedger'])}}?contact_id={{$contact->id}}&action=pdf" class="btn btn-default btn-xs" id="print_ledger_pdf"><i class="fas fa-file-pdf"></i></button>
