<div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(['url' => action([\Modules\Clinic\Http\Controllers\PatientPaymentController::class, 'update'], [$payment_line->id]), 'method' => 'put', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang( 'clinic::patient.edit_payment' )</h4>
      </div>
