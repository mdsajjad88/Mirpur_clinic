  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
            ...
            <div class="input-group">
              <span class="input-group-addon">
                ...
                @if ($transaction->type == 'sell_return')
                  {!! Form::select("method", $payment_types, $payment_line->method, ['class' => 'form-control select2 payment_types_dropdown', 'required', 'style' => 'width:100%;', 'disabled']) !!}
        ...
        <div class="clearfix"></div>
          @include('clinic::payments.payment_type_details')
        <div class="col-md-12">
          <div class="form-group">
