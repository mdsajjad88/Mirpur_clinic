...
@section('content')
    ...
    <div class="container-fluid" id="prescription_form">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <select class="form-control select2" id="other_prescription_app_id">
                                    ...
                                    @foreach ($otherPrescription as $appointmentId => $presc)
                                        <option value="{{ $appointmentId }}" data-prescription-id="{{ $presc['id'] ?? '' }}">
                                            {{ $presc['label'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        {{-- <a href="{{ action([\Modules\Clinic\Http\Controllers\PrescriptionsController::class, 'showInDoctor'], [$prescription->appointment_id ?? '']) }}"
                                            class="btn btn-primary btn-sm" id="load_prescription">@lang('clinic::lang.load')</a> --}}
                                    ...
                                    @foreach ($prescribedComplain as $complain)
                                        <div class="complainField row mt-1">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                {!! Form::hidden('template_name', null, ['id' => 'template_name']) !!}
                ...
                @component('components.widget', ['class' => 'box-primary'])
                    <div class="prescription-left-widget3">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-3">
                                <div class="row">
                                    <div style="padding-right: 0; padding-left: 0" class="col-md-6">
                                        {!! Form::number('current_height_feet', $data['current_height_feet'] ?? '', [
                                            'class' => 'form-control custom-input',
                                            'placeholder' => 'Feet',
                                            'max' => 6,
                                        ]) !!}
                                    ...
                                    <div style="padding-right: 0; padding-left: 0" class="col-md-6">
                                        {!! Form::number('current_height_inches', $data['current_height_inches'] ?? '', [
                                            'class' => 'form-control custom-input',
                                            'placeholder' => 'Inches',
                                            'max' => 12,
                                        ]) !!}
                            ...
                            <div class="col-md-3">
                                {!! Form::number('current_weight', $data['current_weight'] ?? '', [
                                    'class' => 'form-control custom-input',
                                    'placeholder' => 'kg'
                                ]) !!}
                            </div>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-3">
                                {!! Form::number('pulse_rate', $data['pulse_rate'] ?? '', ['class' => 'form-control custom-input', 'placeholder' => 'bpm']) !!}
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="row">
                                    <div style="padding-right: 0; padding-left: 0" class="col-md-5">
                                        {!! Form::number('systolic_pressure', $data['systolic_pressure'] ?? '', [
                                            'class' => 'form-control custom-input',
                                            'placeholder' => 'sbp',
                                        ]) !!}
                                    </div>
                                    ...
                                    <div style="padding-right: 0; padding-left: 0" class="col-md-5">
                                        {!! Form::number('diastolic_pressure', $data['diastolic_pressure'] ?? '', [
                                            'class' => 'form-control custom-input',
                                            'placeholder' => 'dbp',
                                        ]) !!}
                                    </div>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-3">
                                {!! Form::text('respiratory', $data['respiratory'] ?? '', ['class' => 'form-control custom-input', 'placeholder' => 'b/m']) !!}
                            </div>
                            <div class="col-md-3">
                                {!! Form::label('body_temp', __('clinic::lang.temperature')) !!}
                            </div>
                            <div class="col-md-3">
                                {!! Form::text('body_temp', $data['body_temp'] ?? '', ['class' => 'form-control custom-input', 'placeholder' => '°F']) !!}
                            </div>
                        </div>
                        <div class="row mt-1">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                {!! Form::text('body_fat_percent', $data['body_fat_percent'] ?? '', [
                                    'class' => 'form-control custom-input',
                                    'readonly',
                                    'placeholder' => '%'
                                ]) !!}
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-3">
                                {!! Form::text('fat_mass_percent', $data['fat_mass_percent'] ?? '', [
                                    'class' => 'form-control custom-input',
                                    'readonly',
                                    'placeholder' => '%'
                                ]) !!}
                            ...
                            <div class="col-md-3">
                                {!! Form::text('lean_mass_percent', $data['lean_mass_percent'] ?? '', [
                                    'class' => 'form-control custom-input',
                                    'readonly',
                                    'placeholder' => '%'
                                ]) !!}
                        ...
                        <div class="row mt-1">
                            <div class="col">
                                <table class="table table-bordered table-th-green table-striped"
                                    ...
                                    <thead>
                                        <tr>
                                            <th id="medicine_name_th" style="border-right: 1px solid black;">
                                        ...
                                        @if ($prescribedMedicines && $prescribedMedicines->isNotEmpty())
                                            @foreach ($prescribedMedicines as $medicine)
                                                <tr>
                                                    ...
                                                    <td> {!! Form::select('dosage_form[]', $meals, $medicine->dosage_form, ['class' => 'form-control custom-input']) !!}</td>
            ...
            <div class="col-md-3">
                @component('components.widget', ['class' => 'box-primary'])
                    <div class="prescription-right-widget">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                {!! Form::select('template_id', [null => 'Select a Template'] + $templates, $templateId, [
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <button type="submit" name="action" value="save" class="btn btn-success">@lang('clinic::lang.save')</button>
                <button type="submit" name="action" value="save_and_print"
                    class="btn btn-primary">@lang('clinic::lang.save_and_print')</button>
                <button type="submit" name="action" value="save_as_template" class="btn make_app">Save as
                    Template</button>
            </div>
            <div class="col-md-3"></div>
        </div>
    ...
    <div class="modal fade view_modal_intake_form" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
    </div>
