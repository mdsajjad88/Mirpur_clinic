    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">
                    ...
                    @lang('clinic::doctor.edit_doctor_info')
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="doctor_designation {{ $provider->is_doctor == 1 ? 'show' : 'hide' }}">
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('designation', __('Doctor Designation') . ':') !!}
                            <div class="input-group">

                                {!! Form::text('designation', $provider->designation, ['class' => 'form-control', 'placeholder' => __('Doctor Designation')]) !!}
                            </div>
                        </div>
                    </div>
