<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        @php
            $form_id = 'doctor_specialities_add_form';
            $url = action([\Modules\Clinic\Http\Controllers\doctor\DoctorController::class, 'storeSpecialities']);
        @endphp
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Add a Speacilities</h4>
        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('term_short_name', null, [
                                'class' => 'form-control',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('year_of_experience', null, [
                                'class' => 'form-control',
    ...
    <script>
        $(document).ready(function() {
            var id = @json($id); // Ensure you're correctly passing the variable from your backend

            $('#doctor_specialities_add_form').validate({
                rules: {
                    term_name: {
                        required: true,
                        remote: {
            ...
            $('#doctor_specialities_add_form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success == true) {
                            $('div.add_specilities_form').modal('hide'); // Hide the modal
                            toastr.success(result.msg); // Show success message
                            $('#specilities_table').DataTable().ajax.reload();
                        } else {
