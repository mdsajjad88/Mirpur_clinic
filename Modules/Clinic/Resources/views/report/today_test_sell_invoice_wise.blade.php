<table class="table table-bordered table-striped ajax_view" id="clinic_test_sell_report_today">
    <thead>
        <tr>
    ...
    <tfoot>
        <tr style="font-size: 12px" class="bg-gray footer-total text-left">
            ...
            <td colspan="2" class="today_payment_method_count"></td>
            <td class="today_footer_payment_status_count"></td>
            <td class="today_footer_sale_total"></td>
            <td class="today_footer_total_paid"></td>
            <td class="today_footer_total_remaining"></td>
            <td class="today_footer_total_campaign_discount"></td>
            <td class="today_footer_total_special_discount"></td>
            <td class="today_footer_total_sell_return_due"></td>
            <td colspan="14"></td>
        </tr>
    </tfoot>
</table> 