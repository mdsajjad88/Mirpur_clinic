...
@section('title', __('Draft Sell List'))
@section('content')
            ...
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary"
                        href="{{ action([\Modules\Clinic\Http\Controllers\ClinicSellController::class, 'create'], ['status' => 'draft']) }}">
                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('clinic::lang.appointment_date')</th>
                            <th>@lang('purchase.ref_no')</th>
                            <th>@lang('clinic::lang.patient_name')</th>
                            <th hidden>@lang('lang_v1.contact_no')</th>
                            <th>@lang('clinic::lang.type')</th>
                            <th>@lang('lang_v1.total_items')</th>
                            <th>@lang('sale.remarks')</th>
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'transactions.appointment_date'
                    },
                    {
                        data: 'invoice_no',
                        name: 'invoice_no'
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            // Combine contact_name and mobile into a single string
