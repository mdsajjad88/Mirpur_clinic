        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                @component('components.widget', ['class' => 'box-solid'])
                    ...
                    <div class="{{ $transaction->status == 'draft' ? 'col-sm-3' : 'col-sm-4' }}">
                        <div class="form-group">
                    ...
                    @if ($transaction->status == 'draft')
                        <div class="{{ $transaction->status == 'draft' ? 'col-sm-3' : 'col-sm-4' }}">
                            <div class="form-group">
                                {!! Form::label('appointment_date', __('clinic::lang.bill_final_date') . ':*') !!}
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                                    {!! Form::text('appointment_date', $today ?? now()->format('d-m-Y H:i:s'), [
                                        'class' => 'form-control',
                                        'readonly',
                                        'required',
                                    ]) !!}
                    ...
                    @endif
                    <div class="{{ $transaction->status == 'draft' ? 'col-sm-2' : 'col-md-3' }}">
                        <div class="form-group">
                            <div class="checkbox">
                                <br>
                                <label>
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var totalAmount = parseFloat($('.price_total').text().replace(/,/g, '')) || 0;
            var sub_type = $('#sub_type').val();
            if (sub_type == 'consultation') {
                $('.payment-amount').val(totalAmount.toLocaleString());
            }
