						...
						<div class="col-xs-6 col-sm-3">
							<div class="small-box bg-yellow">
								...
								@if (auth()->user()->can('print_invoice'))
									<a href="#" class="print-invoice small-box-footer bg-green" data-href="{{ route('sell.printInvoice', [$sale->id]) }}">
									@lang('lang_v1.print_invoice') <i class="fas fa-print" aria-hidden="true"></i>
									</a>
                                @endif
					         </div>
				         </div>
