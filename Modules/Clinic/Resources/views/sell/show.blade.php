        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="@if (!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
                    ...
                    <br>
                        ...
                        <p>
                          <b>{{ __('clinic::lang.reference') }}:</b>

                          @if (!empty($sell->reference))
                        
                            {{ $sell->reference->first_name ?? '' }}
                            {{ $sell->reference->last_name ?? '' }}
                            @if ($sell->reference->designation)
                                {{ '(' . $sell->reference->designation . ')' }}
                            @endif
                            @endif
                ...
                <div class="@if (!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
                    ...
                    @endphp
                    @if (count($medias))
                        @include('clinic::sell.partials.media_table', ['medias' => $medias])
                    @endif
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="table-responsive">
                        @include('clinic::sell.partials.sale_line_details')
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <table class="table bg-gray">
                                ...
                                @foreach ($sell->payment_lines as $payment_line)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($payment_line->note || $payment_line->transaction_no)
                                                {{ ucfirst($payment_line->note) }}
                                                <br>
                                                @isset($payment_line->transaction_no)
                                                    <small><strong>Transaction No.:
                                                        </strong>{{ $payment_line->transaction_no }}</small>
                                                @endisset
                                            @else
                                                --
                                            @endif
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @includeIf('clinic::activity_log.activities', ['activity_type' => 'sell'])
                </div>
            </div>
        </div>
