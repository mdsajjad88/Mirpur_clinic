            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        {!! Form::select('comment_id', $comments->toArray(), $commentId, [
                    ...
                    <div class="col-sm-3">
                        ...
                        {!! Form::select('district_id', $districts->toArray(), $districtId, [
                            'class' => 'form-control select2',
                            'style' => 'width:100%',
                            'id' => 'district_id',
                            'placeholder' => 'All',
            ...
            <div class="col">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="old_report_tab">
                            @component('components.widget', ['class' => 'box-primary', 'title' => 'Feedback Report'])
                                <table class="table table-striped data-table fs-9" id="comment_wise_patient_table" style="width: 100% !important;">
                                    <thead>
                                        <tr>
                                            <th>SL</th>
                        ...
                        <div class="tab-pane" id="new_report_tab">
                            @component('components.widget', ['class' => 'box-primary', 'title' => 'Feedback Report'])
                                <table class="table table-striped data-table fs-9" id="comment_wise_patient_table_new" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th>Comment Info</th>
                                            <th>Patient Info</th>
                        ...
                        <div class="tab-pane active" id="chart_report_tab">
                            {!! $chart->script() !!}
                            {!! $chart->container() !!}
                        </div>
                    </div>
