...
<style>
    ...
    #userName:hover{
            color: #000000; 
            text-shadow: 4px 4px 4px 4px rgba(63, 102, 180, 0.4), 0 0 25px rgba(23, 23, 158, 0.2);
...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col">
            <h1 id="userName">Welcome <br> Dear, <br>  {{Auth::user()->first_name}} {{Auth::user()->last_name}}</h1>
        </div>
    </div>
</div>
@endsection
