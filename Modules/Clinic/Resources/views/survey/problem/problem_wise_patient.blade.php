            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        {!! Form::select('problem_id', ['' => 'All'] + $problems->pluck('name', 'id')->toArray(), null, [
                    ...
                    <div class="col-sm-3">
                        ...
                        {!! Form::select('district_id', ['' => 'All'] + $districts->pluck('name', 'id')->toArray(), null, [
                            'class' => 'form-control select2',
                            'style' => 'width:100%',
                            'id'=>'district_id'
                        ]) !!}
            ...
            <div class="col">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="old_report_disease_tab">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var reportNewTable = $('#problem_wise_patient_new').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('problem.wise.patient.new') }}", // Use the correct URL
                    data: function(d) {
                        d.district_id = $('#district_id').val();
                        d.problem_id = $('#problem_id').val(); // Filter based on the selected problem
                        d.start_date = $('#start_date').val();
                        d.end_date = $('#end_date').val();
                        d.category_id = $('#category_id').val();
                    }
