        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    {!! Form::select('reference_id', ['' => 'All'] + $references->toArray(), $referenceId, [
            ...
            <div class="col">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="old_reference_report_tab">
                            @component('components.widget', ['class' => 'box-primary', 'title' => 'Reference wise Patient'])
                                <table class="table table-striped" id="reference_wise_patient" style="width:100% !important;">
                                    <thead>
                                        <tr>
                                            <th>SL</th>
                                            <th>Reference</th>
                        ...
                        <div class="tab-pane active" id="chart_reference_report_tab">
                            {!! $chart->script() !!}
                            {!! $chart->container() !!}
                        </div>
                    </div>
