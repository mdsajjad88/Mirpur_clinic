            ...
            <div class="modal-body">
                ...
                <form id="addReport" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <select name="patient_profile_id" class="form-control" id="patient_profile_id" multiple required>
                            <option value="">Select Patient</option>
                            @foreach ($patients as $patient)
                            <option value="{{$patient->patient_profile_id}}">{{$patient->first_name}}</option>
                            @endforeach
                        </select>
                        </div>
