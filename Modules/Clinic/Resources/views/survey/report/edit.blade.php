            ...
            <div class="modal-body">
                ...
                <form  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <select name="patient_profile_id" class="form-control" id="patient_profile_id" required>
                            <option value="" disabled selected>Select Patient</option>
                            @foreach ($patients as $patient)
                            <option value="{{$patient->patient_profile_id}}">{{$patient->first_name." ".$patient->last_name}}</option>
                            @endforeach()
                        </select>
...
<script>
    $(document).ready(function(){
        ...
        var patient = "<?php echo $report->patient_profile_id ?>";
        ...
        $('#patient_profile_id').val(patient);
