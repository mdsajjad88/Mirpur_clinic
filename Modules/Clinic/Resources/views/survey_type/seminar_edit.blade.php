<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\Modules\Clinic\Http\Controllers\SurveyTypeController::class, 'update'], [$surveyType->id]).'?type=seminar',
            'method' => 'PUT',
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Edit Seminar Info</h4>
        </div>
        ...
        <div class="modal-body">
            ...
            @if (!empty($surveyType->banner_img))
                <div class="form-group">
                    <label>Current Banner:</label><br>
                    <img src="{{ asset('uploads/img/' . $surveyType->banner_img) }}" alt="Banner"
            ...
            <div class="form-group">
                ...
                {!! Form::number('patient_allow_count', $surveyType->patient_allow_count?? null, [
                    'class' => 'form-control',
                    'min' => '1',
            ...
            <div class="form-group">
                ...
                {!! Form::number('fee', $surveyType->fee?? null, [
                    'class' => 'form-control',
                    'min' => '1',
            ...
            <div class="form-group">
                ...
                {!! Form::number('mobile', $surveyType->mobile?? null, ['class' => 'form-control', 'placeholder' => 'Seminar Mobile No', 'required']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('website_url', 'Our Website url?') !!}
                {!! Form::text('website_url', $surveyType->website_url?? null, ['class' => 'form-control', 'placeholder' => 'Website url', 'required']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('already_registered_link', 'Already Registered Link?') !!}
                {!! Form::text('already_registered_link', $surveyType->already_registered_link?? null, [
                    'class' => 'form-control',
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        {!! Form::checkbox('is_show_division', 1, $surveyType->is_show_division == 1 ? true : false, ['class' => 'input-icheck', 'id' => 'is_show_division']) !!}
                    </div>
                    <div class="col-xs-6">
                        {!! Form::label('is_show_district', 'Is show district?') !!}
                        {!! Form::checkbox('is_show_district', 1, $surveyType->is_show_district == 1 ? true : false, ['class' => 'input-icheck', 'id' => 'is_show_district']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        {!! Form::label('is_show_primary_disease', 'Is show primary disease?') !!}
                        {!! Form::checkbox('is_show_primary_disease', 1, $surveyType->is_show_primary_disease == 1 ? true : false, [
                            'class' => 'input-icheck',
                    ...
                    <div class="col-xs-6">
                        ...
                        {!! Form::checkbox('is_show_secondary_disease', 1, $surveyType->is_show_secondary_disease == 1 ? true : false, [
                            'class' => 'input-icheck',
            ...
            <div class="form-group">
                ...
                {!! Form::checkbox('is_active', 1, $surveyType->is_active == 1 ? true : false, ['class' => 'input-icheck', 'id' => 'is_active']) !!}
            </div>
        </div>
