    ...
    <section class="content">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" @if (!auth()->user()->can('clinic.brand.create')) disabled @endif
                                    ...
                                    data-href="{{ action([\Modules\Clinic\Http\Controllers\ClinicBrandController::class, 'create']) . '?sub_type=test&quick_add=true' }}"
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('type', __('clinic::test.test_type') . ':*') !!} @show_tooltip(__('tooltip.product_type'))
                        {!! Form::hidden('product_type', 'test') !!}
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // tinymce.init({
            //     selector: '#test_product_description',
            //     plugins: 'image',
            //     toolbar: 'insert | image',
            //     automatic_uploads: true, 
            //     image_upload_url: 'your-server-side-image-upload-url', 
