...
@section('title', __('Edit Therapy Info'))
@section('content')
...
<section class="content-header">
    <h1>@lang('clinic::lang.edit_therapy')</h1>
    <!-- <ol class="breadcrumb">
...
{!! Form::open(['url' => action([\Modules\Clinic\Http\Controllers\TherapyController::class, 'update'] , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-8">
              <div class="form-group">
                {!! Form::label('product_description', __('clinic::lang.therapy_desc') . ':') !!}
