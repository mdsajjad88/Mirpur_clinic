...
@endphp
<table style="min-width: 100%" class="table table-bordered table-striped ajax_view hide-footer" id="product_table">
    <thead>
        <tr>
            <th><input type="checkbox" id="select-all-row" data-table-id="product_table"></th>
            <th>@lang('messages.action')</th>
            <th>@lang('clinic::lang.therapy_name')</th>
            ...
            {{-- <th>@lang('clinic::lang.therapy_type')</th> --}}
