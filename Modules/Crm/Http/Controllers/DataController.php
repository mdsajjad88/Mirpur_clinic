...
class DataController extends Controller
{
    ...
    public function modifyAdminMenu()
    {
        ...
        if ($is_crm_enabled) {
            if (\Menu::has('clinic-sidebar-menu')) {
    Menu::modify('clinic-sidebar-menu', function ($menu) {
        $menu->url(
            ...
            if (! empty($crm_settings['enable_order_request'])) {
                $menu = Menu::instance('clinic-sidebar-menu');
    ...
    public function user_permissions()
    {
        $permissions = [
            ...
            [
                'value' => 'crm.call_subject_store',
                'label' => __('crm::lang.call_subject_store'),
                'default' => false,
            ],
            [
                'value' => 'crm.view_call_subject',
                'label' => __('crm::lang.view_call_subject'),
                'default' => false,
            ],
            [
                'value' => 'crm.call_subject_update',
                'label' => __('crm::lang.call_subject_update'),
                'default' => false,
            ],
            [
                'value' => 'crm.call_subject_delete',
                'label' => __('crm::lang.call_subject_delete'),
                'default' => false,
            ],
            [
                'value' => 'crm.call_tag_store',
                'label' => __('crm::lang.call_tag_store'),
                'default' => false,
            ],
            [
                'value' => 'crm.view_call_tag',
                'label' => __('crm::lang.view_call_tag'),
                'default' => false,
            ],
            [
                'value' => 'crm.call_tag_update',
                'label' => __('crm::lang.call_tag_update'),
                'default' => false,
            ],
            [
                'value' => 'crm.call_tag_delete',
                'label' => __('crm::lang.call_tag_delete'),
                'default' => false,
            ],
            [
                'value' => 'crm.access_all_call_log',
                'label' => __('crm::lang.access_all_call_log'),
                'default' => false,
            ],
            [
                'value' => 'crm.view_call_campaign',
                'label' => __('crm::lang.view_call_campaign'),
                'default' => false,
            ],
            [
                'value' => 'crm.create_call_campaign',
                'label' => __('crm::lang.create_call_campaign'),
                'default' => false,
            ],
            [
                'value' => 'crm.update_call_campaign',
                'label' => __('crm::lang.update_call_campaign'),
                'default' => false,
            ],
            [
                'value' => 'crm.delete_call_campaign',
                'label' => __('crm::lang.delete_call_campaign'),
                'default' => false,
            ],
            [
                'value' => 'call.campaign_filter.view',
                'label' => __('crm::lang.campaign_filter_view'),
                'default' => false,
            ],
            [
                'value' => 'call.campaign_filter.create',
                'label' => __('crm::lang.campaign_filter_create'),
                'default' => false,
            ],
            [
                'value' => 'call.campaign_filter.update',
                'label' => __('crm::lang.campaign_filter_update'),
                'default' => false,
            ],
            [
                'value' => 'call.campaign_filter.delete',
                'label' => __('crm::lang.campaign_filter_delete'),
                'default' => false,
            ],
            [
                'value' => 'crm.send_sms',
                'label' => __('crm::lang.send_sms'),
                'default' => false,
            ],
        ];
