...
use Modules\Clinic\Entities\{Reference, PatientProfile, PatientDisease, Problem};
...
class LeadController extends Controller
{
    ...
    public function index()
    {
        ...
        $sources = Reference::pluck('name', 'id');
    ...
    public function create()
    {
        ...
        return view('contact.create')
            ->with(compact('types', 'store_action', 'sources', 'life_stages', 'users', 'module_form_parts', 'diseases'));
    }
