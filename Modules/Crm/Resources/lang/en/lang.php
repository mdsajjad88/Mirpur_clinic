...
return [
    ...
    'my_leads' => 'My Leads',
    'my_leads_to_customer_conversion_in_this_month' => 'My leads to customer conversion in this month',
    ...
    'add_call_subject' => 'Add Call Subject',
    'update_call_subject' => 'Update Call Subject',
    'update_call_tag' => 'Update Call Tag',
    'call_logs' => 'Call Logs',
    'type' => 'Type',
    'contact' => 'Contact',
    'note' => 'Note',
    ...
    'profile' => 'Profile',
    'call_tag_store' => 'Call Tag Store',
    'call_subject_store' => 'Call Subject Store',
    'edit_call_log_info' => 'Edit Call Log Info',
    ...
    'total' => 'Total',
    'filter' => 'Filter',
    'access_all_call_log' => 'Access all call logs',
    'call_subject_summary' => 'Call Subject Summary',
    'create_follow_up' => 'Create Follow Up',
    'select_lead' => 'Select Lead',
    'edit_schedule_status' => 'Edit Schedule Status',
    'confirm' => 'Confirm',
    'new' => 'New',
    'followup' => 'Followup',
    'old' => 'Old',
    'user_wise_appointment_summary' => 'User Wise Appointment Summary',
    'view_call_subject' => 'View Call Subject',
    'view_call_tag' => 'View Call Tag',
    'not_confirmed' => 'Not Confirmed',
    'daily_call_report' => 'Daily Call Report',
    ...
    'followup_patients' => 'Followup Patients',
    'old_patients' => 'Old Patients',
    'therapy_appointments' => 'Therapy Appointments',
    'next_day_appointments' => 'Next Day Appointments',
    ...
    'total_appointment_taken' => 'Total Appointment Taken',
    'total_appointment_taken_today' => 'Total Appointment Taken Today',
    'appointment_taken' => 'Appointment Taken',
    'today_appointments' => 'Today Appointments',
    'scheduled_for_today' => 'Scheduled for Today',
    'call_campaigns' => 'Call Campaigns',

    'call_subject_update' => 'Call Subject update',
    'call_subject_delete' => 'Call Subject Delete',
    'call_tag_delete' => 'Call Tag Delete',
    'call_tag_update' => 'Call Tag Update',
    ...
    'csv_file' => 'CSV File',
    'csv_format_help' => 'CSV should contain name and mobile number columns',
    'process_csv' => 'Process CSV',
    'csv_processed_contacts' => 'Processed Contacts',
    'sms_body' => 'SMS Body',
    'sms_body_placeholder' => 'Type your message here. Use {name} to personalize.',
    'characters' => 'characters',
    'sms' => 'SMS',
    'send_sms' => 'Send SMS',
    'sms_send_results' => 'SMS Send Results',
    ...
    'select_contact_filter' => 'Select Contact Filter',
    ...
    'individual_logs' => 'Individual Logs',
    'sent_time' => 'Sent Time',
