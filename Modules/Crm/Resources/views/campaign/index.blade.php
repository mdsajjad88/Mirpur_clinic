...
@section('content')
    ...
    <section class="content no-print">
            ...
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-sm btn-primary pull-right m-5"
                        href="{{ action([\Modules\Crm\Http\Controllers\CampaignController::class, 'create']) }}">
        ...
        <div class="modal fade camp_modal" tabindex="-1" role="dialog"></div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.show_data_campaign_wise', function(e) {
            e.preventDefault();
            var href = $(this).data('href');
            $('.camp_modal').load(href, function() {
                $(this).modal('show');
                $('#camp-wise-data-table').DataTable({
                    paging: true,
                    searching: false,
                    info: true,
                    lengthChange: false,
