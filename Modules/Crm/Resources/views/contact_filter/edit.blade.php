            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('contact_type', 
                            ['customer' => __('Customer'), 'lead' => __('Lead'), 'supplier' => __('Supplier')], 
                            $filters['contact_type'] ?? null, 
                            ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('All')]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('has_transaction', 
                            ['1' => __('Yes'), '0' => __('No')], 
                            $filters['has_transaction'] ?? null, 
                            ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('All')]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('last_transaction_days', __('Last Transaction Within (Days)')) !!}
                        {!! Form::number('last_transaction_days', $filters['last_transaction_days'] ?? null, 
                            ['class' => 'form-control', 'min' => 1, 'placeholder' => __('Days')]) !!}
                    </div>
                </div>
            </div>
