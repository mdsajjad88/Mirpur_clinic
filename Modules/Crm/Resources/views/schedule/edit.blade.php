        ...
        {!! Form::open(['url' => action([\Modules\Crm\Http\Controllers\ScheduleController::class, 'update'], ['follow_up' => $schedule->id]), 'method' => 'put', 'id' => 'edit_schedule' ]) !!}
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('customer_name', $label .':*') !!}
                            {!! Form::text('customer_name', $customer->name, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required', 'style' => 'width: 100%;', 'disabled']) !!}
                            <input type="hidden" name="contact_id" value="{{$schedule->contact_id}}">
                       </div>
                    </div>
                </div>
                <div class="row">
