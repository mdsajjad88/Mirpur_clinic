...
@section('content')
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'contact_id_filter',
                            $contact ? [$contact->id => $contact->name] : ['' => __('messages.search')],
                            null,
                            [
                                'class' => 'form-control select2 contact_id_filter',
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.widget', ['class' => 'box box-solid', 'title' => __('crm::lang.all_schedules')])
                    @slot('tool')
                        <div class="box-tools">
                            <button type="button" class="btn btn-primary btn-add-schedule hide">
    ...
    <div class="modal fade edit_schedule_status" tabindex="-1" role="dialog"></div>
        ...
        $(function() {
            ...
            follow_up_datatable = $("#follow_up_table").DataTable({
                ...
                ajax: {
                    url: "/crm/follow-ups",
                    data: function(d) {
                        d.contact_id = $("#customer_id_clinic").val();
            ...
            $(document).on('change',
                '#customer_id_clinic, #assgined_to_filter, #status_filter, #schedule_type_filter, #follow_up_by_filter',
                function() {
                    follow_up_datatable.ajax.reload();
                });
