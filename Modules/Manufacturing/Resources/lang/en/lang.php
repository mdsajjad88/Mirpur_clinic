...
return [
    ...
    'select_ingredient_only_not_for_selling_product' => 'Select Ingredient Only Not For Selling Product',
    ...
    'access_production_edit' => 'Access Production Edit',
    ...
    'auto_mfg' => 'Auto Production',
    'mass_add_product_auto_mfg' => 'Add Product Auto Production',
    'mass_add_product_auto_mfg_help' => 'Enable automatic product production when a sale is made from the POS. The selected product will be automatically produced in the required quantity and sold.',
    'mass_remove_product_auto_mfg' => 'Remove Product Auto Production',
    'mass_remove_product_auto_mfg_help' => 'Disable automatic product production when a sale is made from the POS. The selected product will not be automatically produced.'
];
