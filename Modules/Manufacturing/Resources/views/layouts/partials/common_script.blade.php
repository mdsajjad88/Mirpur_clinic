	...
	$(document).ready( function () {
    	...
    	recipe_table = $('#recipe_table').DataTable({
	        ...
	        columns: [
	            ...
	            { data: 'auto_mfg', name: 'auto_mfg', searchable: false },
...
$(document).on('click', '#mass_add_product_auto_mfg', function(e){
    e.preventDefault();
    var selected_rows = [];
    var unit_prices = [];
    var i = 0;
    ...
    if(selected_rows.length > 0){
        swal({
            ...
            if (willDelete) {
                ...
                $.ajax({
                    method: "post",
                    url: "/manufacturing/add-product-auto-mfg",
                    dataType: 'json',
                    data: data,
                    success: function(result) {
...
$(document).on('click', '#mass_remove_product_auto_mfg', function(e){
    e.preventDefault();
    var selected_rows = [];
    var unit_prices = [];
    var i = 0;
    ...
    if(selected_rows.length > 0){
        swal({
            ...
            if (willDelete) {
                ...
                $.ajax({
                    method: "post",
                    url: "/manufacturing/remove-product-auto-mfg",
                    dataType: 'json',
                    data: data,
                    success: function(result) {
                        if (result.success == true) {
