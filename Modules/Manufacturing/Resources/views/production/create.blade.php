            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            @php
                                $attributes = ['class' => 'form-control input_number'];
                                if (!auth()->user()->can('manufacturing.access_production_edit')) {
                                    $attributes['readonly'] = 'readonly';
                                }
                            @endphp
                            {!! Form::text('mfg_wasted_units', 0, $attributes) !!}
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input_inline">
                            ...
                            {!! Form::text('production_cost', 0, $attributes) !!}
                            <span>
                                {!! Form::select(
