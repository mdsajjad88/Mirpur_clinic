<div class="box box-solid">
	<div class="box-body">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					{!! Form::label('search_product_' . $ig_index, __('manufacturing::lang.select_ingredient').':') !!} @show_tooltip(__('manufacturing::lang.select_ingredient_only_not_for_selling_product'))
