...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('manufacturing')->group(function () {
    ...
    Route::delete('/destroyall/{id}', [\Modules\Manufacturing\Http\Controllers\ProductionController::class, 'destroyall'])->name('destroyall');

    Route::post('/update-product-prices', [Modules\Manufacturing\Http\Controllers\RecipeController::class, 'updateRecipeProductPrices']);
    Route::post('/add-product-auto-mfg', [Modules\Manufacturing\Http\Controllers\RecipeController::class, 'addRecipeAutoMfg']);
    Route::post('/remove-product-auto-mfg', [Modules\Manufacturing\Http\Controllers\RecipeController::class, 'removeRecipeAutoMfg']);
});
