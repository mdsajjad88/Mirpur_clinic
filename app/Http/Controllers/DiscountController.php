...
class DiscountController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $variation_ids = $request->input('variation_ids');  // The passed variation IDs

            // If variation_ids are provided, skip category/brand filtering
            ...
            // If variation_ids are provided, sync only the provided variations
            if (!empty($variation_ids)) {
                // Sync only the specific variation IDs
                $discount->variations()->sync($variation_ids);
            } else {
                // Fallback to category/brand filtering if no variation_ids are provided
                ...
                // Sync the collected variation IDs (if any)
                if (!empty($variation_ids)) {
                    $discount->variations()->sync($variation_ids);
                }
            }
