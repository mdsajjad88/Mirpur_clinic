                ...
                return Datatables::of($document_note)
                    ->addColumn('action', function ($row) use ($notable_type, $permissions) {
                        ...
                        if (in_array('view', $permissions)) {
                            $viewUrl = action([\App\Http\Controllers\DocumentAndNoteController::class, 'show'], [
                                $row->id,
                                'notable_id' => $row->notable_id,
                                'notable_type' => $notable_type
                            ]);

                            $html .= '<a href="#" data-href="' . $viewUrl . '" 
                      class="btn btn-xs btn-primary view_a_docs_note" 
                    ...
                    <i class="fa fa-eye"></i>
                        ...
                        if (in_array('create', $permissions)) {
                            $editUrl = action([\App\Http\Controllers\DocumentAndNoteController::class, 'edit'], [
                                $row->id,
                                'notable_id' => $row->notable_id,
                                'notable_type' => $notable_type
                            ]);

                            $html .= '<a href="#" data-href="' . $editUrl . '" 
                      class="btn btn-xs btn-warning docs_and_notes_btn" 
                    ...
                    <i class="fa fa-edit"></i>
                        ...
                        if (in_array('delete', $permissions)) {
                            $deleteUrl = action([\App\Http\Controllers\DocumentAndNoteController::class, 'destroy'], [
                                $row->id,
                                'notable_id' => $row->notable_id,
                                'notable_type' => $notable_type
                            ]);

                            $html .= '<a href="#" data-href="' . $deleteUrl . '" 
                      class="btn btn-xs btn-danger delete_docus_note" 
                      style="margin-left: 5px;" 
                      title="' . __('messages.delete') . '" id="delete_docus_note">
