...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $is_doctor = $this->businessUtil->is_doctor(auth()->user());
        ...
        $woocommerce_order = Transaction::where('status', 'draft')->whereNotNull('woocommerce_order_id')->count();

        session()->forget('clinic_location');
        return redirect()->route('clinic.dashboard');
        return view('home.index', compact('sells_chart_1', 'sells_chart_2', 'widgets', 'all_locations', 'common_settings', 'is_admin', 'woocommerce_order'));
    }
