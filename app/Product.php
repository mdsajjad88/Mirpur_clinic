...
class Product extends Model
{
    ...
    {
        return $this->hasMany(TestParameterHeading::class, 'test_id');
    }
    /**
    ...
    {
        return $this->belongsToMany(\App\Product::class, 'res_product_modifier_sets', 'modifier_set_id', 'product_id')->withPivot('modifier_limit');
    }
