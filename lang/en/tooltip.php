...
return [
    ...
    */
    ...
    'sku' => "Unique Product ID (SKU) <br><br>
    Keep the checkbox checked to automatically generate the SKU. <br><small class='text-muted'>You can modify the SKU prefix in Business Settings.</small>",
    ...
    'sub_sku' => 'Sku is optional. <br><br><small>Automatically generate sku.<small>',
    ...
    'seminar_patient_info_import_tooltip' => 'Select a CSV file to import patient details such as name and mobile number.',
