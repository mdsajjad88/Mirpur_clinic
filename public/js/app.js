$(document).ready(function() {
    ...
    contact_table = $('#contact_table').DataTable({
        ...
        "ajax": {
            ...
            "data": function ( d ) {
                ...
                if ($('#sms_status_filter').length > 0) {
                    d.sms_status_filter = $('#sms_status_filter').val();
                }
            }
        },
        aaSorting: [[1, 'desc']],
    ...
    $(document).on('change', '#has_no_sell_from, #cg_filter, #status_filter, #assigned_to, #sms_status_filter', function(){
        contact_table.ajax.reload();
    });
                    ...
                    columns: [
                        ...
                        { data: 'category', name: 'c.name' },
                        {
                            ...
                            render: function (data, type, row) {
                                // Wrap the product names in a scrollable div
...
$(document).on('shown.bs.modal', '.patient_modal', function(e) {
    $('.dob-date-picker').datepicker({
      autoclose: true,
      endDate: 'today',
    });
...
$(document).on('shown.bs.modal', '.doctor_modal', function(e) {
    $('.dob-date-picker').datepicker({
      autoclose: true,
      endDate: 'today',
    });
});
$(document).on('shown.bs.modal', '.edit_doctor_modal', function(e) {
    $('.dob-date-picker').datepicker({
      autoclose: true,
      endDate: 'today',
    });
});
$(document).on('shown.bs.modal', '.add_degree_form', function(e) {
    $('.dob-date-picker').datepicker({
      autoclose: true,
      endDate: 'today',
    });
});
$(document).on('shown.bs.modal', '.edit_profile_form', function(e) {
    $('.dob-date-picker').datepicker({
      autoclose: true,
      endDate: 'today',
    });
