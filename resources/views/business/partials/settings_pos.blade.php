<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('pos_settings[courier_services]', __('Courier Services') . ':') !!}
                {!! Form::text('pos_settings[courier_services]', isset($pos_settings['courier_services']) ? $pos_settings['courier_services'] : null, ['class' => 'form-control']) !!}
            </div>
        </div>
    </div>    
    <hr>
