<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
          {!! Form::label('disable_category_woocommerce', __( 'product.disable_product_category_in_woocommerce' ) . ':') !!} <br>
          {!! Form::select('disable_category_woocommerce[]', 
              $category_dropdown, // All categories
              $dropdown_disabled->pluck('category_id')->toArray(), // Pre-selected values
              [
