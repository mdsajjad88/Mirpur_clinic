...
<div class="pos-tab-content">
    ...
    <div class="row sms_service_settings @if($sms_service != 'other') hide @endif" data-service="other">
        ...
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('send_to_param_name', 'Username:*') !!}
                {!! Form::text('sms_settings[send_to_param_name]', $sms_settings['send_to_param_name'], ['class' => 'form-control','placeholder' => __('lang_v1.send_to_param_name'),'required', 'id' => 'send_to_param_name']) !!}
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                {!! Form::label('msg_param_name', 'Password:*') !!}
                {!! Form::text('sms_settings[msg_param_name]', $sms_settings['msg_param_name'], ['class' => 'form-control','placeholder' => __('lang_v1.msg_param_name'),'required', 'id' => 'msg_param_name']) !!}
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
