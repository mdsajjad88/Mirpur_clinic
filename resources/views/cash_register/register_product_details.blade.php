            ...
            <tbody>
                @foreach ($details['sell_details'] as $detail)
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="display_currency" data-currency_symbol="true">{{ $detail->total_before_tax }}</span> 
        ...
        <table class="table table-condensed">
            ...
            @foreach ($details['product_details_by_customer_group'] as $detail)
                <tr>
                    ...
                    <td>
                        <span class="display_currency" data-currency_symbol="true">{{ $detail->total_amount }}</span>
                        @php
                            $total_amount += $detail->total_amount;
                        @endphp
                    </td>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                @foreach ($details['shipping_details'] as $detail)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $detail->delivered_to ?? '--' }}</td>
                        <td>
                            <span class="display_currency" data-currency_symbol="true">
                                {{ $detail->shipping_charges }}
                            </span>
                        </td>
                        <td>
                            <span class="display_currency" data-currency_symbol="true">
