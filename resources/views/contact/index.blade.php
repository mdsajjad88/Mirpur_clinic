...
<section class="content">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label for="sms_status_filter">@lang('sale.sms_status'):</label>
            {!! Form::select('sms_status_filter', 
                [
                    '1' => __('lang_v1.send_sms'), 
                    '0' => __('lang_v1.not_send_sms')
                ], 
                null, 
                ['class' => 'form-control', 'id' => 'sms_status_filter', 'placeholder' => __('lang_v1.all')]
            ) !!}
        </div>
    </div>    
    @endcomponent
