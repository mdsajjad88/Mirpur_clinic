                    ...
                    <div class="col-md-12">
                        ...
                        @foreach ($document_note->media as $media)
                            ...
                            @if (in_array(strtolower($fileExtension), $allowedExtensions))
                                ...
                                <img style="width: 200px; height: auto; margin-bottom: 10px;"
                                    src="{{ $media->display_url }}" alt="{{ $media->display_name }}">
                            @elseif ($fileExtension === 'pdf')
                                <!-- If media is a PDF, embed it in the modal -->
                                <div style="margin-bottom: 10px;">
                                    <embed src="{{ $media->display_url }}#navpanes=0&toolbar=1" type="application/pdf" width="100%" height="800px" />

                                    <p>
                                        <a href="{{ $media->display_url }}" target="_blank"
                                            class="btn btn-sm btn-primary mt-2">
                                            <i class="fa fa-eye"></i> View PDF in new tab
                                        </a>
