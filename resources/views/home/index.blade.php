...
<section class="content-header content-header-custom">
    @if(!empty($woocommerce_order)&&$woocommerce_order > 0)
    <div class="alert alert-info">
        <span>You have {{ $woocommerce_order }} pending order for confirmation.</span>
        <a href="{{ action([\App\Http\Controllers\SellController::class, 'getEcommerce']) }}" style="color: blue !important;">
            Please click here to view all pending orders
        </a>
    </div>
    @endif
