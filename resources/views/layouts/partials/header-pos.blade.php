  ...
  <div class="row">
      ...
      <div class="m-6 mt-5" style="display: flex;">
        <p><strong>@lang('sale.location'): &nbsp;</strong> 
          @if(empty($transaction->location_id))
            ...
            @else
                {{-- Display the default location name if there is only one location --}}
    ...
    <div class="col-md-6">
      ...
      @endif
        ...
        <div class="status-toggle btn btn-flat m-6 btn-xs m-5 pull-right btn-primary">
            <!-- Status label aligned to the left -->
            <span id="statusLabel" class="status-label">Sell</span>
            <!-- Toggle switch aligned to the right -->
            <label class="switch" title="Switch to demand">
