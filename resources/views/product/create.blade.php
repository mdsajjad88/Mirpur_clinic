    ...
    <section class="content">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="checkbox" id="change_sku_mandatory" style="transform: scale(2);"> &nbsp;&nbsp;
                <label for="change_sku_mandatory">Autogenerate SKU</label>
                {!! Form::text('sku', null, ['class' => 'form-control', 'placeholder' => __('product.sku'), 'id' => 'sku']) !!}
            </div>
        </div>                                                    
        <div class="col-sm-4">
            <div class="form-group">
...
$(document).ready(function() {
    function updateSkuRequirement() {
        if ($('#change_sku_mandatory').is(':checked')) {
            $('#sku').prop('required', false);
            $('#sku').val(''); // Clear SKU field if it's autogenerated
        } else {
            $('#sku').prop('required', true);
        }
    }

    updateSkuRequirement();

    $('#change_sku_mandatory').on('change', function() {
        updateSkuRequirement();
    });
});
