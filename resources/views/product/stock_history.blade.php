...
@section('content')
    ...
    @endphp --}}
        ...
        <div class="row">
        <div class="col-md-12">
            <h4 class="text-center"><b>Product Price History</b></h4>
            <table class="table table-bordered table-striped" id="price_history_table">
                <thead>
                    <tr>
                        <th>Type</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7">No price history available for this Product.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @includeIf('activity_log.activities', ['activity_type' => 'product'])
        </div>
    </div>
    @endcomponent
</section>
