			...
			<div class="col-sm-12">
				<table class="table">
					<tr>
						<td class="col-md-3">
							<div class="form-group">
								...
								{!! Form::select('discount_type', [ 
									...
									'', ['class' => 'form-control select2', 'id' => 'discount_type']) !!}
							</div>
						</td>
						<td class="col-md-3">
							<div class="form-group">
						...
						<td class="col-md-3">
							<div class="form-group" id="discount_for_section" style="display:none;">
								{!! Form::label('discount_for', __( 'Discount For' ) . ':') !!}
								{!! Form::select('discount_for', [
									'subtotal_after_tax' => __('Subtotal After tax'),
									'subtotal_before_tax' => __('Subtotal before tax')
	...
	<script type="text/javascript">
		...
		$('#discount_type').change(function() {
            ...
            if (discountType === 'percentage') {
                $('#discount_for_section').show();
            } else {
                $('#discount_for_section').hide();
            }
        });
	</script>
