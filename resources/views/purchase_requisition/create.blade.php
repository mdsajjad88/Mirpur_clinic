...
@section('content')
    ...
    <section class="content-header">
        <div class="custom-row">
            <div class="text-left"> <a style="font-size: 24px" href="{{action([\App\Http\Controllers\PurchaseRequisitionController::class, 'index'])}}" ><i class="fas fa-backward"></i>&nbsp; <strong> @lang('lang_v1.add_purchase_requisition')</strong></a> </div>
            <div class="text-right">
                <a href="#" data-href="{{ action([\App\Http\Controllers\PurchaseRequisitionController::class, 'demandList']) }}" class="cursor-pointer damant-list-show btn btn-success">
                    @lang('Demand List')
                </a>
            </div>
        </div>        
    ...
    <section class="content">
                ...
                <div class="row" style="align-items: center;">
                    ...
                    <div class="col-md-2">
                        <div style="margin-top: 25px;" class="form-group">
                            <button type="button" id="generate_order" class="btn btn-primary">
                                @lang('Order')
                            </button>
                        </div>
                    </div>
        ...
        @endcomponent
        <div class="modal fade demand_list_view_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel"></div>
    </section>
@endsection
...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.damant-list-show', function (e) {
                e.preventDefault();
                var href = $(this).data('href');
                $('.demand_list_view_modal').load(href, function () {
                    $(this).modal('show');
                });
            });
