                ...
                @component('components.filters', ['title' => __('report.filters')])
                    ...
                    <div class="col-md-3 hide">
                        <div class="form-group">
                            ...
                            {!! Form::select('psr_customer_group_id', $customer_groups, null, [
                                'class' => 'form-control select2',
                                'style' => 'width:100%',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('product_date_filter', __('report.date_range') . ':') !!}
                            {!! Form::text('date_range', null, [
                                'placeholder' => __('lang_v1.select_a_date_range'),
                                'class' => 'form-control',
                                'id' => 'product_date_filter',
                                'readonly',
                            ]) !!}
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <li>
                        ...
                        <li class="active">
                            <a href="#psr_grouped_single_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-bars"
                                    aria-hidden="true"></i> Product Sell Report</a>
                        </li>
                        <li>
                            <a href="#psr_grouped_single_inactive" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-bars" aria-hidden="true"></i> Product Inactivity Report</a>
                        </li>
                        {{-- <li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="psr_grouped_single_tab">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped"
                                    id="product_sell_grouped_single_report_table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>@lang('sale.product')</th>
                                            <th>@lang('product.sku')</th>
                        ...
                        <div class="tab-pane" id="psr_grouped_single_inactive">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="product_sell_inactive_report_table"
                                    style="width: 100%;">
                                    <thead>
                                        @php
                                            $colspan = 8;
                                        @endphp
                                        <tr>
                                            <th><input type="checkbox" id="select-all-row"
                                                    data-table-id="product_sell_inactive_report_table"></th>
                                            <th>@lang('sale.product')</th>
                                            <th>Locations</th>
                                            <th>@lang('product.sku')</th>
                                            <th>Category</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var ranges = {
                ...
                'Last Month': [moment().subtract(1, 'months').startOf('month'), moment().subtract(1, 'months')
                    .endOf('month')
                ],
                'Last 90 Days': [moment().subtract(89, 'days'), moment()],
                'Last 6 Months': [moment().subtract(179, 'days'), moment()],
                'Last 1 Year': [moment().subtract(364, 'days'), moment()],
                'Last 18 Months': [moment().subtract(545, 'days'), moment()], // 18 months = 545 days
            ...
            $('#product_date_filter').daterangepicker(
                dateRangeSettings,
                function(start, end) {
                    $('#product_date_filter').val(start.format(moment_date_format) + ' ~ ' + end.format(
                        moment_date_format));
                        product_sell_grouped_report_single_inactive.ajax.reload();
                        product_sell_grouped_report_single.ajax.reload();
                }
            );
            $('#product_date_filter').on('cancel.daterangepicker', function(ev, picker) {
                $('#product_date_filter').val('');
                product_sell_grouped_report_single_inactive.ajax.reload();
                product_sell_grouped_report_single.ajax.reload();
            });
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    if (result.success == true) {
                                        ...
                                        product_sell_grouped_report_single_inactive.ajax
                                            .reload();
                                    } else {
