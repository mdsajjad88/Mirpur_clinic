            ...
            <div class="row">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#primary_permission_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-cubes"
                                    aria-hidden="true"></i> @lang('lang_v1.permissions')</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="primary_permission_tab">
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            {{-- <div class="row check_group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'view_stock_history', in_array('view_stock_history', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('role.view_stock_history') }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- @if (in_array('purchases', $enabled_modules) || in_array('stock_adjustment', $enabled_modules))
                                ...
                                <hr style="opacity: 0.5; border-top: 1px solid #ccc;">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="checkbox">
                                                <label>
                                                    {!! Form::checkbox('permissions[]', 'stock_transfer.view', in_array('stock_transfer.view', $role_permissions), [
                                                        'class' => 'input-icheck',
                                                    ]) !!}
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    {!! Form::checkbox(
                                                        ...
                                                        in_array('stock_transfer.status', $role_permissions),
                                                        ['class' => 'input-icheck'],
                                                    ) !!}
                                                    {{ __('role.stock_transfer.status') }}
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="checkbox">
                                                <label>
                                                    {!! Form::checkbox(
                                                        ...
                                                        in_array('stock_transfer.invoice', $role_permissions),
                                                        ['class' => 'input-icheck'],
                                                    ) !!}
                                                    {{ __('role.stock_transfer.invoice') }}
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                            ...
                            {{-- <div class="row check_group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'discount_no_limit', in_array('discount_no_limit', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!}
                                                {{ __('Full Access to Special Discount') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox(
                                                    'permissions[]',
                                                    'disable_discount_from_sale_screen',
                                                    in_array('disable_discount_from_sale_screen', $role_permissions),
                                                    ['class' => 'input-icheck'],
                                                ) !!}
                                                {{ __('Enable Special Discount Screen with Conditions') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="row check_group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox(
                                                    'permissions[]',
                                                    'view_product_price_from_sale_screen',
                                                    in_array('view_product_price_from_sale_screen', $role_permissions),
                                                    ['class' => 'input-icheck'],
                                                ) !!}
                                                {{ __('lang_v1.view_product_price_from_sale_screen') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                {{ __('Edit product line discount from Sale Screen') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                {{ __('Add/Edit/Delete Campaign Discount') }}
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'send_sms', in_array('send_sms', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!}
                                                {{ __('Send SMS in Demand List') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'sale_invoice_date', in_array('sale_invoice_date', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!}
                                                {{ __('Sale Invoice Date Edit') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox(
                                                    'permissions[]',
                                                    'sale_invoice_payment_date',
                                                    in_array('sale_invoice_payment_date', $role_permissions),
                                                    ['class' => 'input-icheck'],
                                                ) !!}
                                                {{ __('Sale Invoice Payment Date Edit') }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row check_group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'expiry_report.view', in_array('expiry_report.view', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('View stock expiry report') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'spg_add', in_array('spg_add', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('lang_v1.spg_add') }}
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'spg_view', in_array('spg_view', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('lang_v1.spg_view') }}
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'spg_edit', in_array('spg_edit', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('lang_v1.spg_edit') }}
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'spg_delete', in_array('spg_delete', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('lang_v1.spg_delete') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'spg_active_deactive', in_array('spg_active_deactive', $role_permissions), [
                                                    'class' => 'input-icheck',
                                                ]) !!} {{ __('lang_v1.spg_active_deactive') }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <h4>@lang('lang_v1.lab_permissions')</h4>
                                </div>
                                <div class="col-md-9">
                                    <div class="col-md-3">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'lab.invoice.invoiceView', in_array('lab.invoice.invoiceView', $role_permissions), [
                                                'class' => 'input-icheck',
                                            ]) !!} {{ __('lang_v1.lab_assistant_view') }}
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                        {!! Form::checkbox('permissions[]', 'lab.invoice.nurseInvoiceView', in_array('lab.invoice.nurseInvoiceView', $role_permissions), [
                                            'class' => 'input-icheck',
                                        ]) !!} {{ __('lang_v1.lab_nurse_view') }}
                                    </div>
                                </div>
                            </div> --}}
