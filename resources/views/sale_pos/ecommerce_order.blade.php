@extends('layouts.app')
@section('title', __( 'Ecommerce Pending Orders'))
@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>Ecommerce Pending Orders</h1>
</section>
...
<section class="content no-print">
    ...
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => 'All Orders'])
        {{-- @slot('tool')
            <div class="box-tools">
