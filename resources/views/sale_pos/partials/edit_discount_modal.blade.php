	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::select('discount_type_modal', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], $discount_type , ['class' => 'form-control', 'required']) !!}
				            </div>
				        </div>
				    </div>
				    @php
				...
				<!-- New Discount Note Field -->
				<div class="row @if(!$is_discount_enabled) hide @endif">
					<div class="col-md-12">
						<div class="form-group">
							{!! Form::label('special_discount_note', __('lang_v1.discount_note') . ':') !!}
							{!! Form::textarea('special_discount_note', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('lang_v1.enter_discount_note')]) !!}
							<span id="not_require"></span>
						</div>
					</div>
				</div>
				<br>
