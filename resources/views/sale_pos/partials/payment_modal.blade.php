	...
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				{!! Form::text("", null, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_transaction_no'), 'id' => "card_transaction_number", 'autofocus', 'required' => 'required']) !!}
				<div class="text-danger" id="card_transaction_no_error" style="display: none;"></div>
			</div>
		</div>
		<div class="clearfix"></div>
		<div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text("payment[0][transaction_no_1]", null, ['class' => 'form-control', 'placeholder' => __('Enter Transaction No.'), 'id' => "transaction_no", 'autofocus', 'required' => 'required']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea("payment[0][note]", null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Enter Notes'), 'id' => "note"]) !!}
                            </div>
                        </div>
                    </div>
                </div>
