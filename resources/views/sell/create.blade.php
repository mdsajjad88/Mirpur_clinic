        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                @component('components.widget', ['class' => 'box-solid'])
                    ...
                    @endif
                    @php
                        $date_not_disabled = auth()->user()->can('sale_invoice_date');
                    @endphp
                    <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                        <div class="form-group">
                ...
                @endcomponent
                @php
                    $discount_hidden = auth()->user()->can('disable_discount_from_sale_screen');
                @endphp
                @component('components.widget', ['class' => 'box-solid'])
                    <div class="col-md-4  @if ($sale_type == 'sales_order' || $discount_hidden == false) hide @endif">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 @if ($sale_type == 'sales_order'  || $discount_hidden == false) hide @endif"><br>
