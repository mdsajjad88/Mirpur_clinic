...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        var selling_price_group_table = $('#selling_price_group_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/selling-price-group', // Ensure this is the correct endpoint
                type: 'GET'
            },
            columns: [
                { data: 'name', name: 'name' }, // Assuming 'name' is the first column
                { data: 'description', name: 'description' }, // Assuming 'description' is the second column
                {
                    data: 'action', // This column will contain the HTML for action buttons
                    name: 'action',
                    orderable: false,
                    searchable: false
                }
            ...
            columnDefs: [
                {
                    targets: 2, // The action column index
                    orderable: false,
                    searchable: false
                }
            ]
