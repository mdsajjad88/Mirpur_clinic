...
@section('content')
    ...
    <section class="content-header">
        <a href="{{action([\App\Http\Controllers\SellingPriceGroupController::class, 'index'])}}"><h3><b style="font-size: 30px;"><i class="fas fa-arrow-left fa-xs"></i>  </b>Selling Price Group: {{ $sellingPriceGroup->name }}</h3></a>
    </section>
    <!-- Main content -->
        ...
        <div class="box box-solid">
            <div class="box-header">
                <h3 class="box-title">@lang('lang_v1.selling_price_group') Product List</h3>
                 <a href="{{action('App\Http\Controllers\SellingPriceGroupController@updatePriceGroup',$sellingPriceGroup->id)}}" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a>
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table id="selling_price_group_products_table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('product.msrp_sell_price')</th>
                                <th>@lang('product.discount')</th>
                                <th>{{ $sellingPriceGroup->name }} Price</th>
                                <th>@lang('product.profit_percentage')</th>
                                <th>@lang('product.our_profit')</th>
