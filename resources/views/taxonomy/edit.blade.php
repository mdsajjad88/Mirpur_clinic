<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      @elseif ($category->category_type == 'life_stage')
        {!! Form::label('short_code',__('lang_v1.type') . ':*') !!}
        {!! Form::select('short_code', ['customer' => __('Customer'), 'lead' => __('Lead')], $category->short_code, ['class' => 'form-control', 'placeholder' => __('Select')]) !!}
      @endif
