<div class="modal-dialog transaction_payment_modal" role="document">
  <div class="modal-content">
    ...
    {!! Form::hidden('clinic_location', $clinic_location) !!}
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        @php
             $date_not_disabled = auth()->user()->can('sale_invoice_payment_date');
        @endphp
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('paid_on', @format_datetime($payment_line->paid_on), ['class' => 'form-control', 'readonly', 'required', $date_not_disabled ? '' : 'disabled']) !!}
            </div>
          </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="modal-footer">
      <button data-transaction-id = '{{ $transaction->id }}' type="submit" id="sellReturnPay" class="btn btn-primary">@lang( 'messages.save' )</button>
