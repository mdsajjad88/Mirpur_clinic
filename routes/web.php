...
use App\Http\Controllers\ReconcileDetailsController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin', 'ClinicSidebarMenu', 'MirpurSidebar'])->group(function () {
    ...
    Route::get('product-demand-list', [PurchaseRequisitionController::class, 'demandList']);
    ...
    Route::get('/districts/{division}', [AddressController::class, 'getDistricts']);
    Route::get('/upazilas/{district}', [AddressController::class, 'getUpazilas']);
    ...
    Route::resource('reconciles', ReconcileController::class);
    Route::post('/reconciles/check-unique-name', [ReconcileController::class, 'checkUniqueName'])->name('reconciles.checkUniqueName');
    Route::resource('reconcile-details', ReconcileDetailsController::class);
    ...
    Route::get('/products/list-for-sale', [ProductController::class, 'getProductSales']);
  ...
  Route::get('random/reconciliation', [CheckController::class, 'reconciliation'])->name('random.reconciliation');
  Route::get('/random/reconciliationCheck', [CheckController::class, 'reconciliationCheck'])->name('random.reconciliationCheck');
  Route::post('/random/reconciliationStore', [CheckController::class, 'reconciliationStore'])->name('random.reconciliationStore');
  ...
  Route::get('/random-check/print/pos/{id}', [CheckController::class, 'printPOS'])->name('random_check.printPOS');
    ...
    Route::get('/sells/ecommerce', [SellController::class, 'getEcommerce']);
    ...
    Route::post('/update-waitlist-quantity', [ProductWaitlistController::class, 'updateQuantity']);
    Route::get('/waitlist/modal/{contact_id}', [ProductWaitlistController::class, 'customerWaitlistModal']);
    Route::get('/waitlists/edit-call-status/{id}', [ProductWaitlistController::class, 'editCallStatus']);
    Route::POST('/waitlists/update-call-status', [ProductWaitlistController::class, 'updateCallStatus']);
    // Route::delete('waitlists/{id}', [ProductWaitListController::class, 'destroy']);    
    Route::post('/waitlists/send-sms', [ProductWaitlistController::class, 'sendSMS']);
    Route::post('/waitlists/send-email', [ProductWaitlistController::class, 'sendEmail']);
    Route::get('/waitlists/archive', [ProductWaitlistController::class, 'archive']);
    Route::delete('/waitlists/force-delete/{id}', [ProductWaitlistController::class, 'forceDelete']);
    Route::delete('/waitlists/both-delete/{id}', [ProductWaitlistController::class, 'bothDelete']);
    Route::resource('waitlists', ProductWaitlistController::class);
    ...
    Route::get('/sells/pos/get_product_row/{variation_id}/{location_id}/{status}', [SellPosController::class, 'getProductRow']);
    ...
    Route::get('/users/archive', [ManageUserController::class, 'archive'])->name('users.archive');
    Route::delete('/users/{id}/force-delete', [ManageUserController::class, 'forceDelete'])->name('users.forceDelete');
    Route::put('/users/{id}/restore', [ManageUserController::class, 'restore'])->name('users.restore');
    ...
    //Reports...
    Route::get('/reports/modifiers-sell-report', [ReportController::class, 'ModifiersSellReport']);
    Route::get('/reports/product-sell-grouped-report', [ReportController::class, 'getproductSellGroupedReport']);
    Route::get('/reports/product-sell-grouped-report-inactive', [ReportController::class, 'getproductQuantityReportInactive']);
    ...
    Route::get('/reports/product-qty-report', [ReportController::class, 'getproductQuantityReport']);

    Route::get('/reports/product-sell-report-with-purchase', [ReportController::class, 'getproductSellReportWithPurchase']);
    Route::get('/reports/product-sell-grouped-report', [ReportController::class, 'getproductSellGroupedReport']);
    Route::get('/reports/product-sell-return-report', [ReportController::class, 'getproductSellReturnReport']);

    Route::post('/expiry-date/store', [ExpiryDateController::class, 'store'])->name('expiry-date.store');
    Route::get('/expiry-dates/filter', [ExpiryDateController::class, 'getExpiryProducts'])->name('expiry_dates.filter');
    Route::get('/expiry/create', [ExpiryDateController::class, 'create'])->name('expiry_dates.create');
    Route::get('/expiry/expiry-report', [ExpiryDateController::class, 'index']);
    ...
    Route::get('/cash-register/clinic{id}', [CashRegisterController::class, 'clinicShow']);
    Route::get('/register-details/overall', [CashRegisterController::class, 'getRegisterDetailsOverall']);
    Route::get('/register-details/overall-data', [CashRegisterController::class, 'overallRegisterData'])->name('overall.register.data');
    ...
    Route::get('/cash-register/clinic-close-register/{id?}', [CashRegisterController::class, 'getClinicCloseRegister']);
    Route::post('/cash-register/close-register', [CashRegisterController::class, 'postCloseRegister']);
    Route::get('/cash-register/pos-print/{id}', [CashRegisterController::class, 'posPrint']);
    Route::get('/cash-register/a4-print/{id}', [CashRegisterController::class, 'a4Print']);
    Route::get('/cash-register/clinic-a4-print/{id}', [CashRegisterController::class, 'clinicA4Print']);
    ...
    Route::get('get-cat-group-row', [SellingPriceGroupController::class, 'getProductRowCat'])->name('seelingPricegroup.catRow');
